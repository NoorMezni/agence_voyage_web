...
exports.getRoleDistribution = exports.getRegistrationsByMonth = exports.getDeletedAccounts = exports.getNewRegistrations = exports.getTotalUsers = void 0;
const db_1 = __importDefault(require("../config/db"));
// ── Carte 1 : Total utilisateurs tous rôles confondus ──
const getTotalUsers = async () => {
    const [[row]] = await db_1.default.query(`SELECT COUNT(*) AS total FROM users`);
    return row.total;
};
...
const getNewRegistrations = async () => {
    const [[thisMont]] = await db_1.default.query(`SELECT COUNT(*) AS total FROM users
     WHERE MONTH(created_at) = MONTH(NOW())
       AND YEAR(created_at)  = YEAR(NOW())`);
    const [[lastMonth]] = await db_1.default.query(`SELECT COUNT(*) AS total FROM users
...
exports.getNewRegistrations = getNewRegistrations;
...
exports.getDeletedAccounts = getDeletedAccounts;
// ── Graphique barres : inscriptions par mois (6 derniers mois) ──
const getRegistrationsByMonth = async () => {
